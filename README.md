...
- ![GitHub stars](https://img.shields.io/github/stars/DLRSP/django-requests-api?label=%E2%AD%90&style=flat-square) [django-requests-api](https://github.com/DLRSP/django-requests-api#readme) - Django application providing a thin requests.Session wrapper with a base URL and small HTTP helpers.
...
- ![GitHub stars](https://img.shields.io/github/stars/DLRSP/django-service?label=%E2%AD%90&style=flat-square) [django-service](https://github.com/DLRSP/django-service#readme) - Django application provide simple category/service details
